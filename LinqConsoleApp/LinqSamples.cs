    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task4()
        {
            ...
            var salmax = sals.Max();
            var res = from emp in Emps
                      where emp.Salary == salmax
                      select emp;

            var res2 = Emps.Where(emp => emp.Salary == salmax);
        ...
        {
            var res = from emp in Emps
                      group emp by emp.Job into empjob
                      select new
                      {
                          EmployeeJob = empjob.Key,
                          EmployeeNumber = empjob.Count()
        ...
        public void Task10()
        {
          ...
          //  var list = new List<String> { "No value", (String)null, (DateTime?)null };
         //   var res2 = res.Union(list);

                      /*
            IEnumerable res2 = { "No value", (String)null, (DateTime?)null } ;
            var res3 = res.Union(); */

          //  var res4 = Emps.Select(emp => emp.Ename + emp.Job + emp.HireDate)
            //    .Union(("No value" + (String)null + (DateTime?)null))
        ...
        public void Task11()
        {
           /* var sals = from emp in Emps
                       select emp;
            var salsmax = sals.Max(); */

            var res = Emps.Select(emp => emp.Salary).Aggregate((val,next) => val= next > val ? next:val);
            var res2 = Emps.Where(emp => emp.Salary == res);
